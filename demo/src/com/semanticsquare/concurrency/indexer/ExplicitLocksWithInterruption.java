...
private Deque<Weblink> queue = new ArrayDeque<>();
	...
	public static void main(String[] args) {
		...
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2000, "Taming Tiger, Part 2", "https://www.javaworld.com/article/2072759/core-java/taming-tiger--part-2.html", "http://www.javaworld.com"));

		//explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2001, "Maruti reports 47% plunge in March sales", "https://www.rediff.com/business/report/coronavirus-maruti-reports-47-plunge-in-march-sales/20200401.htm", "http://www.rediff.com"));

		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2002, "Java Generic Methods", "http://tutorials.jenkov.com/java-generics/methods.html","http://tutorials.jenkov.com"));
